...
class WebViewImpl {
  ...
  setupFocusPropagation () {
    if (!this.webviewNode.hasAttribute('tabIndex')) {
      ...
      // TODO (fsamuel): It would be nice to avoid exposing a tabIndex attribute id:85 gh:87
...
const registerWebViewElement = function () {
  ...
  const nonblockMethods = [
    ...
    // TODO (kevinsawicki): Remove in 2.0, deprecate before then with warnings id:60 gh:61
    'setZoomLevelLimits'
  ]
